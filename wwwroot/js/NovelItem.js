$(document).ready(function () {
    $("#submitreview").click(function () {
        ...
        $.ajax({
            url: "https://localhost:44319/api/crud/postnovelreview",
            type: "POST",
            contentType: "application/json",
            data: jsonReview,
            success: function (response) {
                $.ajax({
                    url: "https://localhost:44319/api/crud/getnovelreviews/" + novelId,
                    type: "GET",
                    contentType: "application/json",
                    success: function (response) {
    ...
    $("#addremovefromfavorites").click(function () {
        ...
        if (addOrRemoveStatus == "Make favorite") {
            ...
            $.ajax({
                url: "https://localhost:44319/api/crud/putfavoritenovel/" + novelId,
                type: "PUT",
                contentType: "application/json",
                success: function (response) {
                }
            ...
            $.ajax({
                url: "https://localhost:44319/api/crud/putfavoritenovel/" + 0,
                type: "PUT",
                success: function (response) {
                }
            });
